...
<title>www.qhjsw.net——PHP多图片上传程序</title>
<meta name="keywords" content="flash上传,免费flash上传,图片上传，免费图片上传，大容量图片上传，图片无刷新上传,图片,批量上传,学习交流论坛，qhjsw.net" />
<meta name="description" content="本站为大家免费提供单个文件最大2M的FLASH上传的PHP程序,qhjsw.net" />
	...
	<div id="cmain">
		<div id="uploadform">
			<form id="form1" action="#" method="post" enctype="multipart/form-data">
				<div>
					<a href="http://www.qhjsw.net/" target="_blank"><img src="images/logo.png" style="height:60px;width:320px;border:none;" alt="www.qhjsw.net"/></a>
				</div>
				<div class="button">
